...
\maketitle
    ...
    \section{Methods}\label{sec:methods}
        ...
        script, presented in Listing~\ref{lst:spectroscopy_analysis}, that
        automates the calibration, wavelength calculation, and determination
        of the Rydberg constant for hydrogen.
